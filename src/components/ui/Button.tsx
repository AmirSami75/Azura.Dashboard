...
// برای مدیریت کلاس ها و جلوگیری از کامفیلیکت کلاس ها
import { cn } from "@/lib/utils";

// cva :  مدیریت کلاس های تیلویند بدون شرط می تونی حالت های مختلف رو تعریف کنی
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-md text-sm font-semibold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-0   disabled:opacity-50  whitespace-nowrap disabled:pointer-events-none",
  {
    variants: {
      color: {
        default:
          "bg-transpatent text-primary hover:bg-primary/70 hover:text-primary-foreground",
...
export interface ButtonProps
  // در اینجا دکمه تمامی ویژگی های پیش فرض المان دکمه رو به ارث میبره
